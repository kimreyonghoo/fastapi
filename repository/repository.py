...
ntrn_db = {
    ...
    'Tryptophan(g)': ['트립토판(㎎)'], 
    'Histidine(g)': ['히스티딘(㎎)'],
    'Vitamin_A(ug)': ['레티놀(㎍)', '비타민 A(㎍ RAE)'], 
    'Vitamin_D(ug)': ['비타민 D(㎍)', '비타민 D3(㎍)', '비타민 D1(㎍)'], 
